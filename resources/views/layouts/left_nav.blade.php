<nav id="left-nav" class="left-nav border-right bg-light">
    <div class="text-center w-100">
        ...
        <ul class="list-inline py-3 mx-auto">
            ...
            <li class="list-inline-item"><a target="_new" href="https://www.linkedin.com/in/mark-brody-7a486914/"><span class="mdi mdi-linkedin"></span></a></li>
            <li class="list-inline-item"><a target="_new" href="https://github.com/markbrody"><span class="mdi mdi-github-circle"></span></a></li>
         </ul>
    </div>
</nav>
